...
def main():
    ...
    generate_pages_recursive(md_src_path, template_path, md_des_path)
...
def generate_page(from_path, template_path, dest_path):
    ...
    html_file = template.replace("{{ Title }}", title).replace("{{ Content }}", content)
...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path):
    ...
    for item in os.listdir(dir_path_content):
        ...
        if os.path.isfile(item_path):
            ...
            generate_page(from_path=item_path , template_path=template_path ,dest_path=des_path )
        else:
            generate_pages_recursive(item_path , template_path , des_path)
